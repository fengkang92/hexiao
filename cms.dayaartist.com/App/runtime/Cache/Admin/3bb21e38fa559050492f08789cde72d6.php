...
<center>
    <form method="post" action="<?php echo U(CourseTeacher/addTeacherCourse);?>">
        <h1 style="margin-top:200px">添加课程老师/价格绑定课程</h1>
        <table>
            <tr>
                <td>老师信息</td>
            </tr>
            ...
            <tr>
                <td>课程名称：</td>
                <td><input type="text" name="course_name" value="test30分钟学会弹钢琴A"></td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;课程简介：</td>
            ...
            <tr>
                <td>课程名称：</td>
                <td><input type="text" name="course_name" value="test30分钟学会弹钢琴B"></td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;课程简介：</td>
                <td><input type="text" name="discribe" value="零基础也 能轻轻松松完整谈曲子"></td>
            </tr>
            <tr>

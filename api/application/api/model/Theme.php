...
class Theme extends BaseModel
{
     ...
     */
    public function dateImg()
    {
        return $this->belongsTo('Image', 'date_img_id', 'id');
    }

    public function shopImg()
    {
        return $this->belongsTo('Image', 'shop_img_id', 'id');
    }

    public function videoImg(){
        return $this->belongsTo('Video','video_img_id','id');
    }
    ...
    {
        $themes = self::with('dateImg,shopImg,videoImg')
            ->find($id);
        return $themes;
    }

...
<div class="page-container">
    <form class="form form-horizontal" action="<?php echo U('Picture/add');?>" method="post" onsubmit="return ac_from();"
          enctype="multipart/form-data">

        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>简介：</label>
            <div class="formControls col-xs-8 col-sm-3">
                <input type="text" class="input-text" placeholder="简介" name="key_word" id="key_word"
                       value="<?php echo ($banner["key_word"]); ?>">
            </div>
        </div>

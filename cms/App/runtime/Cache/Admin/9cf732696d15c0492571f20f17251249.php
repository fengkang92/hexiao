...
<div class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="" class="select">
					<option value="0">卓儿音乐学堂</option>
					<option value="1">文艺剧场</option>
					<option value="11">画室盒子</option>
					<option value="12">美食盒子</option>
					<option value="13">手作盒子</option>
					<option value="13">图书盒子</option>
					<option value="13">瑜伽盒子</option>
					<option value="13">展览盒子</option>
				</select>
				</span> </div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="" id="" placeholder="请输入视频URL" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">时长：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="" id="" placeholder="请输入视频时长" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">视频图片上传：</label>
			<div class="formControls col-xs-8 col-sm-9">
...
$(function(){
	...
	$('.item-add').on("click",function(){
		var html='<div class="item">';
			html+='<textarea placeholder="请输入商品详情文字" rows="3"></textarea>';
				html+='<p>预览</p>';
				html+='<div><img class="pre-img" src=""></div>';
				html+='<input class="item-file" type="file" name="点击上传图片">';
				html+='</div>';

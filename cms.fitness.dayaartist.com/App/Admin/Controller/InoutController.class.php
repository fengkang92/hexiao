...
class InoutController extends Controller {
    ...
    function expUsers(){//导出Excel
        ...
        $xlsModel = M('adminuser');
        $xlsData  = $xlsModel->Field('id,name,uname')->select();
        /*foreach ($xlsData as $k => $v)
        {
        ...
        /*$xlsData = array(
                array('id'=>1,'name'=>'zhangsan','tname'=>'高阳镇','danwei'=>'财务','phone'=>1111),
                array('id'=>2,'name'=>'lisi','tname'=>'高阳镇2','danwei'=>'财务2','phone'=>2222),
            );*/
        //print_r($xlsData);die;
        $this->exportExcel($xlsName,$xlsCell,$xlsData);
